...
const styles = StyleSheet.create({
  ...
  tHead: { flexDirection: 'row', alignItems: 'flex-end', gap: spacing.sm, paddingBottom: 9, borderBottomWidth: BORDER, borderBottomColor: colors.ruleMuted },
  ...
  domainText: { ...type.tiny, fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.7, fontWeight: '700', color: colors.ink, paddingTop: spacing.md, paddingBottom: 4 },
  row: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.lineSoft, minHeight: 40 },
