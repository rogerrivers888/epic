...
export const TIPS = {
  ...
  censusSweeping: ['Sweeping', 'A census is part way through this ground: some of the tiles planned for it have answered and some have not. The number is a floor of a floor \u2014 true as a minimum, false as an answer \u2014 and it is drawn with the tiles beside it so it cannot be read, sorted or compared as a finished count. It sits below the finished rows whatever its size. When the last tile lands the row is written again and reads as the others do.'],
