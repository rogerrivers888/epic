...
export function PrototypesScreen({ route }: {
  ...
  return (
    <ScrollView contentContainerStyle={styles.page}>
      ...
      {/* These are a dated record of decisions, not live screens. Restyling them
          into Epic would leave a page that agrees with nothing that was actually
          reviewed on the day it is dated, so they are left as drawn. */}
      <Text style={type.tiny}>Every page here was drawn before the Epic rebrand (7 September 2026) and is shown as it was reviewed — Roam's wordmark, mint and brand red. The decisions they record still stand; the colours on them do not.</Text>
