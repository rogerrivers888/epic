    ...
    void (async () => {
      ...
      for (const tag of todo) {
        try {
          ...
          // Counted on attempts, not answers: a run whose first lookups fail
          // would otherwise go out with no gap at all, which is exactly the
          // case the pause is for (Codex, 14 Sep 2026).
